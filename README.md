...
- Follows the [black] style guide with [ruff] and [isort].
- Comes with [pre-commit] hook config for black, isort, ruff and [pyupgrade](https://github.com/asottile/pyupgrade).
